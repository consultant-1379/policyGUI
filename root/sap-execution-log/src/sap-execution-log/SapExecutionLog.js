...
define([
    ...
    'eso-commonlib/Utils',
    './regions/logs/ExecutionLogRegion',
    './widgets/copyrightNotice/CopyrightNotice'
], function (core, Loader, Dictionary, TopSection, Constants, Utils, ExecutionLogRegion, CopyrightNotice) {
    'use strict';

    /**
     * Entry class  for Execution Log Management
     */
    ...
    return core.App.extend({
        ...
        onStart: function () {
            ...
            Utils.clearAllSOSessionStorage();
            ...
            var copyrightNotice = new CopyrightNotice({
              okButtonAction: this.okayWithLegalAction.bind(this, topSection, isStartup)
          });

          copyrightNotice.attachTo(this.getElement());
        },

        okayWithLegalAction: function (topSection, isStartup) {
            topSection.setContent(this.getExecutionLogRegion());
        ...
        onResume: function () {
            ...
            this.addEventBusSubscribers();
            this.getExecutionLogRegion().handleRefresh();
        },
        ...
        getExecutionLogRegion: function () {
            if (typeof this.executionLogRegion === 'undefined') {

                this.executionLogRegion = new ExecutionLogRegion({
                    context: this.getContext()
                });
            }
            return this.executionLogRegion;
        },
